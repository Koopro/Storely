...
.app-sidebar {
  /* Sidebar specific styles here */
  /* You can set a min-width if necessary to avoid squishing on smaller screens */
}
...
@media (max-width: 768px) {
  ...
  .app-sidebar {
    /* Adjustments for sidebar on smaller screens */
  }
